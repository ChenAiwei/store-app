...
public class CommodityController {
	...
	public ResultVo<PageVo<CommoditySellRecordDto>> sellRecord(@RequestParam(name = "page",defaultValue = "1") Integer page, @RequestParam (name = "limit",defaultValue = "20") Integer limit, String name,String orderNum, String commodityNum,String channelId,String commodityTypeId,String id,String date){
		PageVo<CommoditySellRecordDto> listSellRecord = commodityService.sellRecord(page,limit,orderNum,name,commodityNum,commodityTypeId,channelId,id,date);
